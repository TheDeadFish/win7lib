...
@ stdcall BaseIsAppcompatInfrastructureDisabled() KERNEL32.IsShimInfrastructureDisabled
...
@ stdcall HeapFree(long long long)  KERNEL32.HeapFree
...
@ stdcall -arch=i386 -ret64 InterlockedCompareExchange64(ptr double double)  KERNEL32.InterlockedCompareExchange64
...
@ stdcall -arch=x86_64 RtlAddFunctionTable(ptr long long)  KERNEL32.RtlAddFunctionTable
@ stdcall -register RtlCaptureContext(ptr)  KERNEL32.RtlCaptureContext
@ stdcall RtlCaptureStackBackTrace(long long ptr ptr)  KERNEL32.RtlCaptureStackBackTrace
@ stdcall -arch=x86_64 RtlCompareMemory(ptr ptr ptr)  KERNEL32.RtlCompareMemory
@ stdcall -arch=x86_64 RtlCopyMemory(ptr ptr ptr)  KERNEL32.RtlCopyMemory
@ stdcall -arch=x86_64 RtlDeleteFunctionTable(ptr)  KERNEL32.RtlDeleteFunctionTable
@ stdcall RtlFillMemory(ptr long long)  KERNEL32.RtlFillMemory
@ stdcall -arch=x86_64 RtlInstallFunctionTableCallback(double double long ptr ptr ptr)  KERNEL32.RtlInstallFunctionTableCallback
@ stdcall -arch=x86_64 RtlLookupFunctionEntry(ptr ptr ptr)  KERNEL32.RtlLookupFunctionEntry
@ stdcall RtlMoveMemory(ptr ptr long)  KERNEL32.RtlMoveMemory
@ stdcall -arch=x86_64 RtlPcToFileHeader(ptr ptr)  KERNEL32.RtlPcToFileHeader
@ stdcall -arch=x86_64 RtlRaiseException(ptr)  KERNEL32.RtlRaiseException
@ stdcall -arch=x86_64 RtlRestoreContext(ptr ptr)  KERNEL32.RtlRestoreContext
@ stdcall RtlUnwind(ptr ptr ptr ptr)  KERNEL32.RtlUnwind
@ stdcall -arch=x86_64 RtlUnwindEx(ptr ptr ptr ptr ptr ptr)  KERNEL32.RtlUnwindEx
@ stdcall -arch=x86_64 RtlVirtualUnwind(ptr ptr ptr long)  KERNEL32.RtlVirtualUnwind
@ stdcall RtlZeroMemory(ptr long)  KERNEL32.RtlZeroMemory
...
@ stdcall -arch=x86_64 __C_specific_handler()  KERNEL32.__C_specific_handler
@ stdcall -arch=x86_64 __chkstk()  KERNEL32.__chkstk
